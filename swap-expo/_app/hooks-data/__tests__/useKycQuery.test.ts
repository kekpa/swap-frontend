...
const mockApprovedKycStatus: KycStatus = {
  ...
  steps: {
    ...
    passcode_setup: { status: 'completed', completed_at: '2024-01-01T00:00:00Z' },
    // Note: biometric_setup removed - biometric is local-only
  },
  process: {},
};
...
const mockPendingKycStatus: KycStatus = {
  ...
  passcode_setup_completed: false,
  ...
  steps: {
    ...
    passcode_setup: { status: 'not_started' },
  },
  process: {},
};
