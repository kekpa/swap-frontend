...
const SearchHeader: React.FC<SearchHeaderProps> = ({
  ...
  const styles = useMemo(() => StyleSheet.create({
    ...
    searchContainer: {
      ...
      flexDirection: "row",
      alignItems: "center",
      backgroundColor: transparent ? 'white' : theme.colors.inputBackground,
      borderRadius: theme.borderRadius.xl,
      paddingHorizontal: theme.spacing.sm,
      height: 40,
      borderWidth: 1,
      borderColor: isSearchActive ? theme.colors.primary : transparent ? 'rgba(255, 255, 255, 0.2)' : theme.colors.inputBorder,
    },
    searchIcon: {
      marginRight: theme.spacing.sm,
    },
